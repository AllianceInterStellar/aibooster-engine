...
import (
	...
	"github.com/AllianceInterStellar/aibooster-engine/v2/hello"
...
func Setup(params *SetupRequest, platformInterface libbox.PlatformInterface) (retErr error) {
	...
	if params.Mode == SetupMode_GRPC_BACKGROUND_INSECURE && static.HiddifyOptions != nil {
		static.HiddifyOptions.EnableTun = true
		Log(LogLevel_INFO, LogType_CORE, "Force EnableTun=true for extension mode")
	}
